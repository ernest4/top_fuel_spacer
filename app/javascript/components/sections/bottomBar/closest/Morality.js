  ...
  return (
    <Card
      ...
      {...{
        ...
        body: `You accumulate <d>renegade points</d> when interacting with others in a
              <d>threatening, apathetic, ruthless</d> way. Infamy will make the smaller pirates fear you.
              However, larger sharks will have you on their radar!
              <space />
              You accumulate <s>paragon points</s> when <s>helping</s> others, <s>sympathizing</s> and 
              choosing <s>diplomacy</s> over fighting. Renown will make you a target to all pirates who want to 
              make a name for themselves! However, trading outpost will give you more favourable rates!`,
